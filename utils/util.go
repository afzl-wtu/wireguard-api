...
func ValidateAndFixSubnetRanges(db interfaces.IStore) error {
...
func GetCurrentHash(db interfaces.IStore) (string, string) {
...
func HashesChanged(db interfaces.IStore) bool {
	old, _ := db.GetHashes()
...
func UpdateHashes(db interfaces.IStore) error {
